      ...
      <div className="bg-zinc-900 border border-zinc-800 w-full max-w-3xl my-8 rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-10 space-y-8">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    required
                    className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl px-5 py-4 text-sm focus:ring-1 focus:ring-emerald-500 outline-none font-mono text-zinc-400 cursor-not-allowed"
                    value={formData.id}
                    disabled
                  />
                </div>
            ...
            <div className="md:col-span-2 pt-8 flex justify-end items-center gap-6">
