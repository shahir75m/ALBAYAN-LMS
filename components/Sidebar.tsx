...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = role === 'ADMIN' ? [
    ...
    { id: 'analytics', label: 'Advanced Analytics', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    ...
    { id: 'history', label: 'Borrow History', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
        ...
        <div className="p-6 flex-1 overflow-y-auto no-scrollbar">
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="block text-zinc-100 font-serif tracking-tight text-xl leading-none">BAYANUL</span>
                <span className="block text-zinc-400 font-serif tracking-tight text-xl leading-none">ULOOM</span>
              </div>
            </div>
            {/* Mobile Close Button */}
            <button
        ...
        <div className="p-6 border-t border-zinc-900 bg-zinc-900/20">
          <div className="flex items-center gap-3 mb-6 p-2 rounded-xl border border-transparent hover:border-zinc-800/50 transition-all">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-zinc-600 font-bold uppercase tracking-wider">{role}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              type="button"
              className="w-full flex items-center gap-3 px-4 py-3 text-xs font-bold uppercase tracking-wider text-zinc-500 hover:text-red-400 hover:bg-red-500/5 rounded-xl transition-all group"
            >
