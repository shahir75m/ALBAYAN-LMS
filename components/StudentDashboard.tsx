...
const StudentDashboard: React.FC<StudentDashboardProps> = ({
  ...
  return (
    <div className="relative">
      ...
      {statusMsg && (
        <div className={`sticky top-4 z-50 mb-8 px-8 py-5 rounded-[2.5rem] border backdrop-blur-md shadow-xl animate-in fade-in slide-in-from-top-4 duration-500 flex items-center justify-between gap-4 ${statusMsg.type === 'success'
